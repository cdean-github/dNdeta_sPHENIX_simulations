...
)
{
    ...
    if (generator == "SIMPLE")
    {
        ...
        // INPUTGENERATOR::SimpleEventGenerator[0]->set_vertex_distribution_mean(0., 0., -19.8); // Previous settings
        // INPUTGENERATOR::SimpleEventGenerator[0]->set_vertex_distribution_width(120e-4, 120e-4, 5.2); //Previous settings
        INPUTGENERATOR::SimpleEventGenerator[0]->set_vertex_distribution_mean(0.02466, 0.3358, -20.72);
        INPUTGENERATOR::SimpleEventGenerator[0]->set_vertex_distribution_width(120e-4, 120e-4, 6.364);
